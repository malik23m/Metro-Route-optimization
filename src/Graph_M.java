...
/*    public Map<String, Map<String, Integer>> getAdjacencyList() {
        ...
        Map<String, Map<String, Integer>> adjacencyList = Map.of();
    ...
    {
        System.out.println("\t Abbottabad Metro Map");
        System.out.println("\t------------------");
        System.out.println("----------------------------------------------------\n");
        ArrayList<String> keys = new ArrayList<>(vtces.keySet());
    ...
    public String display_Stations() {
        ...
        int i = 1;
        for (String key : keys) {
            stations.append(i).append(". ").append(key).append("\n");
            i++;
        }
    ...
    public boolean hasPath(String vname1, String vname2, HashMap<String, Boolean> processed) {
        ...
        if (vtx == null) {
            ...
            System.out.println("Vertex not found: " + vname1);
            return false;
        }
    ...
    {
        g.addVertex("Mandian Station~MS");
        g.addVertex("Supply~Su");
        g.addVertex("Fawara Chowk~FB");
        g.addVertex("Muree Chowk~MuC");
        g.addVertex("Mangal Station~MB");
        g.addVertex("Abbottabad Medical Complex~AMU");
        g.addVertex("Gelani Mart~GM");
        g.addVertex("Mizail Chowk~MC");
        g.addVertex("Bypass~BY");
        g.addVertex("Kakul Link~KL");
        g.addVertex("College Road~CR");
        g.addVertex("Dhamtour~D");
        g.addVertex("Cantt~C");
        g.addVertex("Illiyasi Masjid~IM");
        g.addVertex("Bilal Town~BT");
        g.addVertex("Nawansher~N");
        g.addVertex("Muslim Town~MT");
        g.addVertex("Salhad~S");
        g.addVertex("Chinar Road~CR");
        g.addVertex("Attock Pump~AP");
        g.addEdge("Mangal Station~MS", "Abbottabad Medical Complex~AMU", 12);
        g.addEdge("Abbottabad Medical Complex~AMU", "Gelani Mart~GM", 6);
        g.addEdge("Gelani Mart~GM", "Mandian Station~MB", 5);
        g.addEdge("Mandian Station~MS", "Mizail Chowk~MC", 3);
        g.addEdge("Mizail Chowk~MC", "Bypass~BY", 4);
        g.addEdge("Mizail Chowk~MC", "Supply~S", 10);
        g.addEdge("Bypass~BY", "Bilal Town~BT", 6);
        g.addEdge("Bilal Town~BT", "Illiyasi Masjid~IM", 9);
        g.addEdge("Bilal Town~BT", "Kakul Link~KL", 2);
        g.addEdge("Supply~S", "Kakul Link~KL", 5);
        g.addEdge("illiyasi Masjid~IM", "Nawansher~N", 2);
        g.addEdge("Illiyasi Masjid~IM", "Bani~B", 4);
        g.addEdge("Chinar Road~CR", "Bani~B", 4);
        g.addEdge("Nawansher~N", "Bani~B", 3);
        g.addEdge("Kakul Link~KL", "Muree Chowk~MuC", 4);
        g.addEdge("Muree Chowk~MuC", "Chinar Road~CR", 3);
        g.addEdge("Bani~B", "Dhamtour~D", 5);
        g.addEdge("Chinar Road~CR", "College Road~CR", 6);
        g.addEdge("College Road~CR", "Attock Pump~AP", 2);
        g.addEdge("Muree Chowk~MuC", "Attock Pump~AP", 2);
        g.addEdge("Attock Pump~AP", "Cant~C", 1);
        g.addEdge("Cantt~C", "Fawara Chowk~FC", 3);
        g.addEdge("College Road~CR", "Fawara Chowk~FC", 1);
        g.addEdge("Fawara Chowk~FC", "Muslim Town~MC", 2);
        g.addEdge("Muslim Town~MT", "Salad~S", 3);
    }
